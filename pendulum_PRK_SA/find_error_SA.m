function result = find_error_SA(h, params)
	...
	solve_params = {g0, l, tol, ny, nz, nu, method, b, c, A, Ahat, f, k, g};

	[yn zn Yn Zn Un iter1] = solve_PRK_DAE_single_step(solve_params, h, ynm, znm, unm, x0_trivial, 'simplified newton 2');
	...
	[ynp znp Ynp Znp Unp iter2] = solve_PRK_DAE_single_step(solve_params, r*h, yn, zn, un, [Ynp0; Znp0; Unp0], 'simplified newton 2');
